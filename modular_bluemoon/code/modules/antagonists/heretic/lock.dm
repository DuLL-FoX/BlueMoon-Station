...
/datum/eldritch_knowledge/final_eldritch/lock_final
	...
	desc = "После трёх назначенных душ принесите три человеческих трупа. Обряд раскроет своё место станции и даст 30 секунд на вмешательство. После вознесения вы не нуждаетесь в дыхании и получаете на 25% меньше ушибов и ожогов. Предел увеличивается до 16 печатей и 6 ключей, а урон Размыкания — до 45. «Дом без стен» за 2 секунды окружает вас печатями по краю квадрата 5×5 и восполняет ключи; перезарядка 60 секунд."
	route = PATH_LOCK
