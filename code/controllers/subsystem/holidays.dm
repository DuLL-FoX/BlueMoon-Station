...
//You can then check if it's a special day in any code in the game by doing if(SSholidays.holidays["Groundhog Day"])
...
/datum/controller/subsystem/holidays/proc/getHoliday()
